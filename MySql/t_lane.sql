...
CREATE TABLE `t_lane` (
  ...
  `color` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'lane的颜色',
  ...
  `end_lon` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'lane的终止坐标lon',
  `end_lat` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'lane的终止坐标lat',
  `lane_id` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'lane的id',
  `lane_border_type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'lane_border的类型',
  `speed_limit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '限速',
  `length` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '长度',
...
) ENGINE=InnoDB AUTO_INCREMENT=28537 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
